...
//            [self.imagePickButton setImage:[UIImage BBSImageNamed:@"/3rdParty/ZSSRichEditor/PictureSelect.png"] forState:UIControlStateNormal];
...
//            [self.keyboardButton setImage:[UIImage BBSImageNamed:@"/3rdParty/ZSSRichEditor/KeyboardButton.png"] forState:UIControlStateNormal];
...
- (NSArray *)itemsForToolbar {
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarStrikeThrough]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *strikeThrough = [[ZSSBarButtonItem alloc] initWithImage:[UIImage BBSImageNamed:@"/3rdParty/ZSSRichEditor/ZSSstrikethrough@2x.png"] style:UIBarButtonItemStylePlain target:self action:@selector(setStrikethrough)];
