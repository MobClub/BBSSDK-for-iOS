...
+ (instancetype)actionWithSelectedImage:(UIImage *)image deselectedImage:(UIImage *)deselectedImage title:(NSString *)title selectedTitleColor:(UIColor *)titleColor handler:(void (^)(PopoverAction *action))handler;
