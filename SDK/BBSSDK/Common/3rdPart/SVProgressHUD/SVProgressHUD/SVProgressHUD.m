...
//        UIImage* errorImage = [UIImage imageWithContentsOfFile:[imageBundle pathForResource:@"error" ofType:@"png"]];
        ...
        UIImage* infoImage = [UIImage BBSImageNamed:@"/3rdParty/SVProgressHUD/info@2x.png"];
        UIImage* successImage = [UIImage BBSImageNamed:@"/3rdParty/SVProgressHUD/success@2x.png"];
        UIImage* errorImage = [UIImage BBSImageNamed:@"/3rdParty/SVProgressHUD/error@2x.png"];
